// File: /api/optimize-video-prompt.js
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemInstruction = `You are a prompt engineering expert for Google's Veo text-to-video model. Rewrite the user's idea into a highly effective, cinematic, English prompt. Focus on visual details, camera movements, and lighting. Directly output ONLY the optimized English prompt without preamble.`;
    ...
    console.error('Error calling Gemini API for video prompt optimization:', error);
